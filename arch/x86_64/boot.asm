...
; param: error_code (in ascii) in al
error:
...
check_cpuid:
    ...
    ; Compare EAX and ECX. If they are equal, then the bit wasn't flipped and CPUID isn't supported
    cmp eax, ecx
    je .no_cpuid
    ret
.no_cpuid:
...
check_long_mode:
    ...
    mov eax, 0x80000001     ; argument for extended processor information
...
set_up_page_tables:
    ...
    ; map first P3 table to P2 table
    mov eax, p2_table
    or eax, 0b11    ; present + writable
    mov [p3_table], eax
